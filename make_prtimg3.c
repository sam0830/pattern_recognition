...
#define GYOU_PRT (GYOU_MOJI*2)	/* プリント画像の行数 */
...
int main(int argc,char *argv[])
{
  ...
  sprintf(out_fname,"./alltch.pgm"); /* 出力画像ファイル名 */
